...
namespace NSF.TCC.Sundown.DataAccess
{
    public class CrudDataBase
    {
        ...
        {
            string query = "UPDATE tb_usuario SET nm_nomedoatendente = @nm_nomedoatendente,nm_usuario = @nm_usuario,ds_email = @ds_email,ds_senha = @ds_senha,ds_cpf = @ds_cpf,ds_cep = @ds_cep,nr_casa = @nr_casa,ds_telefone = @ds_telefone WHERE id_usuario = @id_usuario;";
