    ...
    public partial class frmFolhaRH : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("FOLHA SALVA COM SUCESSO.","TOPMOVIE",MessageBoxButtons.OK,MessageBoxIcon.Information);
            ...
            catch (Exception)
            {
                ...
                MessageBox.Show("ERRO AO SALVAR FOLHA DE PAGAMENTO.", "TOPMOVIE - ERROR" , MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
